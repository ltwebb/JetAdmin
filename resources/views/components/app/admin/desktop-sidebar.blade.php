  ...
  <aside class="z-20 hidden w-72 overflow-y-auto mt-18 bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="px-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-8 space-y-3">
            ...
            <li class="relative" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    x-transition:leave-end="transform opacity-0 scale-95" class="w-60" style="display: none;"
                    @click="open = false">
                    <div class="">
