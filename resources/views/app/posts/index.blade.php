                                           ...
                                           <tr>
                                                ...
                                                <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                    ...
                                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2">
                                                        <img class="object-cover w-10 h-10 rounded-full" src="{{  $image->getUrl() }}" alt="{{ $post->title }}" />
                                                    </div>
                                                    @endforeach
                                                </td>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex items-center gap-x-6">
                                                        <a href="{{ route('posts.edit', $post) }}" class="transition-colors duration-200 text-green-500 dark:hover:text-green-700 dark:text-gray-300 hover:text-green-300 focus:outline-none">
