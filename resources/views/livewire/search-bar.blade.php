    ...
    <div class="relative w-full max-w-xl mr-6 focus-within:text-indigo-500 dark:focus-within:text-gray-700">
        ...
        <ul class="bg-white border border-gray-100 w-full mt-2 ">
            ...
            <li class="pl-8 pr-2 py-1 border-b-2 border-gray-100 relative cursor-pointer hover:bg-yellow-50 hover:text-gray-900">
               <a class="flex flex-row" href="{{ route('users.show', $user->id) }}"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-5 h-5">
            ...
            <li class="pl-8 pr-2 py-1 border-b-2 border-gray-100 relative cursor-pointer hover:bg-yellow-50 hover:text-gray-900">
                <a class="flex flex-row" href="{{ route('posts.show', $post->id) }}">
